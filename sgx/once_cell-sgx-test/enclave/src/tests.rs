pub mod unsync {
    ...
    //#[test]
    pub fn unsync_once_cell_drop_empty() {
...
pub mod sync {
    ...
    //#[test]
    pub fn once_cell_get_unchecked() {
        let c = OnceCell::new();
        c.set(92).unwrap();
        unsafe {
